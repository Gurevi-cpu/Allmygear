    ...
    if (_firstCategory) {
      ...
      toolbar.innerHTML = `
        ...
        <div class="toolbar-storage-controls" style="display:${storages.length > 0 ? 'flex' : 'none'}">
          ...
          <button class="toolbar-storage-btn" id="toolbarCreateStorage" title="Create new storage">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      const toolbarCreateStorage = toolbar.querySelector('#toolbarCreateStorage')
      if (toolbarCreateStorage) {
        toolbarCreateStorage.addEventListener('click', () => {
